...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ClassLoader c = Main.class.getClassLoader(); // 获取Test类的类加载器
        System.out.println("Main.class classloader is : " + c);
        ClassLoader c1 = c.getParent(); // 获取c这个类加载器的父类加载器
        System.out.println("Main.class classloader's parent classloader is : " + c1);
        ClassLoader c2 = c1.getParent();// 获取c1这个类加载器的父类加载器
        System.out.println("Main.class classloader's parent classloader's parent classloader is : " + c2);
